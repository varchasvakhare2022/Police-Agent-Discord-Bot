...
client = MyClient(intents=intents, application_id=919149033820418059) #your application id here
...
class Poll_Slash(commands.Cog):
    ...
    async def poll(self, interaction: discord.Interaction, question: str) -> None:
        ...
        await message.add_reaction('<a:yes:969908127145283594>') #change both emojis if it doesn't work
        await message.add_reaction('<a:no:969908471451508766>') #this also
